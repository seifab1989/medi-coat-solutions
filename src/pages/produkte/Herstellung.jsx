  ...
  return (
    ...
    >
      ...
      <section className="mt-12">
        <h2 className="text-2xl md:text-3xl font-semibold">Herstellung von PVD-Schichten</h2>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <Card>
            ...
            <div className="aspect-[4/3] rounded-2xl border border-dashed border-slate-300 bg-gradient-to-br from-slate-50 to-slate-100 mt-4 flex items-center justify-center text-slate-400">
              <span className="text-sm">Bildplatzhalter – Lichtbogenverdampfen</span>
            </div>
          ...
          <Card>
            ...
            <div className="aspect-[4/3] rounded-2xl border border-dashed border-slate-300 bg-gradient-to-br from-slate-50 to-slate-100 mt-4 flex items-center justify-center text-slate-400">
              <span className="text-sm">Bildplatzhalter – Magnetron Sputtern</span>
            </div>
            <p className="text-slate-700 mt-4">
