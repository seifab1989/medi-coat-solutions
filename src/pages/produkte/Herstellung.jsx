  ...
  <GradientBar />
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          ...
          <GradientCard className="h-full">
            ...
            <p className="text-slate-700 mt-4">
              Beim Hochleistungskathodenzerstäuben wird das Material durch Ionenbeschuss aus einer festen Quelle (Target) herausgelöst. Ein Magnetfeld wird verwendet, um die Ionen zu beschleunigen und auf das Target zu lenken. Die Ionen schlagen Atome aus dem Target heraus, die dann auf die Oberfläche des zu beschichtenden Objekts gelangen und dort eine dünne Schicht bilden. Dieses Verfahren ist besonders gut geeignet für temperaturempfidliche Beschichtungsobjekte z. B. Kunststoffe / Polymere.</p>
          </GradientCard>
        </div>
      </section>
    </Container>
