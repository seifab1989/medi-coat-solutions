...
export default function IovaraCoatLogo({ className, ...props }) {
  return (
    <svg viewBox="0 0 400 110" preserveAspectRatio="xMinYMid meet" className={className || 'block'} xmlns="http://www.w3.org/2000/svg" role="img" aria-label="IovaraCoat Logo" {...props}>
      <defs>
        <linearGradient id="iovaraGradient" gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="112" y2="0">
        ...
        <linearGradient id="circleGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#7FB8E5" stopOpacity="1" />
          <stop offset="50%" stopColor="#4A90E2" stopOpacity="1" />
          <stop offset="100%" stopColor="#2C5282" stopOpacity="1" />
        </linearGradient>

        <linearGradient id="ringGradient1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#7FB8E5" stopOpacity="0.8" />
      ...
      <g transform="translate(0, 25)">
        <g aria-label="Iovara">
          ...
          <text x="10" y="30" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="url(#iovaraGradient)">
            ovara
          </text>
        </g>

        <g transform="translate(22, 0)">
        <text x="85" y="30" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="url(#coatGradient)">
          C
        </text>
        ...
        <text x="137" y="30" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="url(#coatGradient)">
          at
        </text>

        <text x="74" y="47" textAnchor="middle" fontFamily="Arial, sans-serif" fontSize="14" fontWeight="normal" letterSpacing="1.7" fill="#9CA3AF">
          PVD Medical Thin Films
        </text>
      </g>
      </g>
    </svg>
